    ...
    <img src="../fotosComunes/maderanav.jpg" class="fondonav"alt="...">
      ...
      <section id="seccion">
        <div id="promo" class="row">
          <div class="col-md-4 col-sm-4 col-xs-12" id="columna" ><a href="#" target="_blank"><img alt="Financiación" class="img-responsive sizefoto" src="productos/Financiacion.jpg"></a></div>
          <div class="col-md-4 col-sm-4 col-xs-12" id="columna" ><a href="#" target="_blank"><img alt="Video instructivo" class="img-responsive sizefoto" src="productos/tutorial.jpg"></a></div>
          <div class="col-md-4 col-sm-4 col-xs-12" id="columna" ><a href="#" target="_blank"><img alt="Retiro en Tienda o Envío a Domicilio" class="sizefoto img-responsive" src="productos/Retiro.jpg"></a></div>
        </div>
