...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark " id="navbar">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="nav navbar-nav mr-auto">
      ...
      <li class="dropdown">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown"
        role="button" aria-haspopup="true" aria-expanded="false">TABLAS DE CARGA<span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="#">GENERAL</a></li>
          <li role="separator" class="divider"></li>
          <li><a href="../AMB/amb.php">PRODUCTOS</a></li>
          <li role="separator" class="divider"></li>
          <li><a href="../AMB/brands.php">MARCAS</a></li>
          <li role="separator" class="divider"></li>
          <li><a href="../AMB/countryes.php">PAISES</a></li>
        </ul>
