    ...
    <body>
      ...
      <img src="../../fotosComunes/growlerscut.jpg" alt="..." id="fototitulo">
              ...
              <div class="card"style="border: solid 0px;">
                ...
                <div id="collapseOne" class="collapsing" aria-labelledby="headingOne" data-parent="#accordionExample">
                  <div class="card-body" id="cardbotonesbajoimagen" >
                    <form class="form-horizontal" id="amb" action="../productos/growlers" method="get" enctype="multipart/form-data">
                    @foreach ($brands as $marcaproducto)
                        <a href='../growlers/growlersbrand/{{$marcaproducto->brand_id}}'>  <button type="button" class="btn" id="botonesdesplegables"  > {{$marcaproducto->brand_name}} </button> </a>
                    @endforeach
                  </form>
                  </div>
                </div>
              ...
              <div id="collapseTWO" class="collapsing" aria-labelledby="headingOne" data-parent="#accordionExample">
                <div class="card-body"id="cardbotonesbajoimagen" >
                  @foreach ($styles as $estiloproducto)
                        <a href='../growlers/growlersstyle/{{$estiloproducto->style_id}}'>  <button type="button" class="btn" id="botonesdesplegables"  > {{$estiloproducto->style_name}}</button> </a>
                  @endforeach
                </div>
              </div>
            </div>
        ...
        <div class="accordion" id="accordionboton" >
            ...
            <div id="collapse3" class="collapsing" aria-labelledby="headingOne" data-parent="#accordionExample">
              <div class="card-body" id="cardbotonesbajoimagen" >
                @foreach ($origins as $paisproducto)
                      <a href='../growlers/growlerscountry/{{$paisproducto->country_id}}'>  <button type="button" class="btn" id="botonesdesplegables"  > {{$paisproducto->country_origin}} </button> </a>
                @endforeach
              </div>
            </div>
          </div>
          ...
          <div class="col-sm">
            <a href='../growlers/growlersrecomendados'> <button type="button" class="btn" id="botones" >RECOMENDADOS</button> </a>
          </div>
        </div>
        <div class="espacionav"id="espacionav"> </div>
