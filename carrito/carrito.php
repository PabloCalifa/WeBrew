          ...
          <div class="espacio" style="padding:3vw">
            ...
            <div class="row" id="carritorowproductos">
              ...
              <div class="col-sm-3">
                <div class"direccion">
                    <h5>DIRECCIÓN</h5>
                    <p> <?=$_SESSION['calle'] . " " . $_SESSION['numdireccion'] . " " . $_SESSION['Pisodireccion'] . " " .  $_SESSION['Provincia'] . " " . $_SESSION['Ciudad'] . "  "
                    . $_SESSION['codigopostal']  ;?> <a href="#"> (otra dirección)  </a> </p>
                </div>
              </div>
            ...
            <div class="row" id="rowcompras" >
              ...
              <div class="col-sm-4">
                <div class="detalleProducto">
                  <p>  <a href="#" ><h4>Cerveza Corona 355 cc</h4></a> </p>
                    <br><b>Cantidad:</b>12 unidades
                    <br><b>Valor:</b>$50,00
                  </div>
                </div>
                  <div class="col-sm-4">
                    <div class="detalleProducto">
                    <br>  <button class="btn" id="boton" style="width:100% " type="submit">Modificar cantidad</button>
                    <br>  <button class="btn" id="boton"style="width:100% "type="submit">Eliminar del Carrito</button>
                    <br>  <button class="btn"id="boton" style="width:100% "type="submit">Ver similares</button>
                  </div>
                </div>
              </div>
            <br> </br>
            <div class="row" id="rowcompras" >
              ...
              <div class="col-sm-4">
                <div class="detalleProducto" >
                  <p>  <a href="#" ><h4>Cerveza Patagonia 355 cc</h4></a> </p>
                      <br><b>Cantidad:</b>12 unidades
                      <br><b>Valor:</b>$50,00
                </div>
              </div>
