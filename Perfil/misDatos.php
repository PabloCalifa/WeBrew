            ...
            <div class="container" id="singin" style="text-align: -webkit-center; padding:0px; margin:0 auto">
              ...
              <form class="form-horizontal" id="singup" action="singUp.php" method="post" enctype="multipart/form-data" >
                <div class="form-group">
                  <div class="titulo" style="text-align-last: center;"><h2>Mis Datos</h2></label>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="password" class="col-sm-2 control-label">Contraseña Anterior</label>
                  <div class="col-sm-10">
                    <input type="password" name="password" class="form-control" id="password" placeholder="Contraseña anterior" value="" >
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="passwordRepeat" class="col-sm-2 control-label">Repetí tú Nueva Contraseña</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  <label  for="dia" class="col-sm-4 control-label">Día
                    <select name="dia" id="dia" value="<?= $_SESSION['dia'] ;?>" >
                  ...
                  <label for="mes" class="col-sm-4 control-label" value="">Mes
                    <select  name="mes" id="mes" value="<?= $_SESSION['mes'] ;?>">
                  ...
                  <label style="" for="ano" class="col-sm-4 control-label"value="">Año
                    <select style="" name="ano" id="ano" value="<?= $_SESSION['ano'] ;?>">
                ...
                <label style="" class="radio-inline">
                  <input type="hidden" name="Sexo" value="<?= $_SESSION['Sexo'] ;?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="calle" class="form-control" id="Calle" placeholder="Calle" value="<?= $_SESSION['calle'] ;?>">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="dia" style="" class="col-sm-offset-2 col-sm-2 control-label">País
                    <select style="" name="pais" id="pais" value="<?= $_SESSION['pais'] ;?>">
                      <option>Argentina</option>
                    </select>
                  </label>
                  <label style="" for="Provincia" class="col-sm-offset-2 col-sm-2 control-label">Provincia
                    <select style="" name="Provincia" id="Provincia"  value="<?= $_SESSION['Provincia'] ;?>">
                      <option value="<?= $_SESSION['Provincia'] ;?>">Buenos Aires</option>
                      <option value="<?= $_SESSION['Provincia'] ;?>">CABA</option>
                      <option value="<?= $_SESSION['Provincia'] ;?>">Catamarca</option>
                      <option value="<?= $_SESSION['Provincia'] ;?>">Chaco</option>
                      <option value="<?= $_SESSION['Provincia'] ;?>">Chubut</option>
                      <option value="<?= $_SESSION['Provincia'] ;?>">Córdoba</option>
                      <option value="<?= $_SESSION['Provincia'] ;?>">Corrientes</option>
                      <option value="<?= $_SESSION['Provincia'] ;?>">Entre Ríos</option>
                      <option value="<?= $_SESSION['Provincia'] ;?>">Formosa</option>
                      <option>Jujuy</option>
