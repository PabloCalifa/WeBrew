      ...
      <div class="espacio" style="padding-top:2vw"></div>
            <div class="col-sm-6">
              <div id="rowProducto"class="row">
                <div class="col-sm-4">
                  <ul>
                    <li class="listaproducto"> <img class="vistaProductos img-thumbnail" src="vistaProductos/heladera1.jpg" alt=" Foto Heladera ">  </li>
                    <li class="listaproducto">  <img class="vistaProductos img-thumbnail" src="vistaProductos/heladera2.jpg" alt="Heladera 2"> </li>
                  </ul>
                    </div>
                <div class="col-sm-6 "><img class="productoPrincipal " src="../index/productos/accesorios/1.png" alt=""> </div>
              </div>
            </div>
            <div class="col-sm-4 divfloat">
              <ul id="listacompraproducto">
                <li class="listadocompra"><h1>Heladera Termina Corona</h1> </li>
                <li class="listadocompra"><h3>Precio $58 </h2>  </li>
